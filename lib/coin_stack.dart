class CoinStack {
  ...
  //Geld arbeitest → vergleiche nach Wert (Summe).
  //Münzsammler bist → vergleiche nach genauer Liste.
  @override
  ...
  CoinStack? operator -(CoinStack other) {
    final newCoins = List<int>.from(
      _coins,
    ); //macht eine Kopie (List.from(coins)), damit man später die Original-Liste nicht mehr „von außen“ ändern kann.
